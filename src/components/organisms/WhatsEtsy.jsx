...
const WhatsEtsy = () => {
  return (
    <div className="font-cg mt-10 bg-[#fffbd8] px-7.5 py-10 text-[#222] lg:mt-20">
      <h2 className="text-center text-[31.01px] leading-[1.2] font-light lg:text-[42px]">
        What is Etsy India?
      </h2>
      <h4 className="font-cw mt-[5.5px] mb-6 text-center text-[16px] leading-[1.7] tracking-[.16px] text-[#595959] underline">
      ...
      <div className="mx-auto mt-9 max-w-[720px] lg:max-w-[900px]">
        ...
        <button
          className="mb-3.5 lg:mb-3.25 inline-flex h-[24px] w-[48px] items-center justify-center gap-0.75 rounded-full bg-[#e5e3d8] p-2"
          aria-label="See more"
        >
      ...
      <div className="mx-auto mt-10 flex max-w-[720px] flex-col items-center font-[500] lg:max-w-[900px]">
        <p className="font-cw px-2 text-center text-[18px] tracking-[0.16px] lg:text-[19.01px]">
          Have a question? Well, we've got some answers.
        </p>
        <div className="font-cw mx-auto mt-3 lg:mb-5 flex w-[174.3px] justify-center rounded-full border px-2 py-2 text-[16px] font-[500] lg:px-1">
          Go to Help Centre
        </div>
      </div>
    </div>
